...
aws ecr get-login-password --region eu-central-1 --profile weather-ecr-agent | docker login --username AWS --password-stdin 931995447723.dkr.ecr.eu-central-1.amazonaws.com
docker build -f ./Dockerfile -t cloud-weather-precipitation:latest .
docker tag cloud-weather-precipitation:latest 931995447723.dkr.ecr.eu-central-1.amazonaws.com/cloud-weather-precipitation:latest
docker push 931995447723.dkr.ecr.eu-central-1.amazonaws.com/cloud-weather-precipitation:latest
